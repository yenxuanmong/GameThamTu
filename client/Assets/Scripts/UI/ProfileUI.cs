...
{
    [Serializable] class UpdateProfileBody  { public string avatarUrl; }
    [Serializable] class PreferencesBody    { public string preferredDifficulty; public bool enableVoiceChat; public bool enableNotifications; }
    [Serializable] class ChangePassBody     { public string currentPassword; public string newPassword; }
    [Serializable] class UpdateResponse     { public bool success; }
